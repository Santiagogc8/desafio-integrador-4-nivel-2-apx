...
import { getDatabase, ref, onValue, onDisconnect, set } from "firebase/database"; // Y getDatabase, refs, onValue 
...
export { rtdb, ref, onValue, onDisconnect, set } // Y exportamos la rtdb, ref y el onValue